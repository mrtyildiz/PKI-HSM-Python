...
from File_Read import Read_File_Func, Read_File_Func2
...
def HSM_CSR(Slot,Slot_PIN,KeyName,csr_fileName,ca_cert_label,Days_int,CompanyName):
    try:
        private_key = Private_Key(Slot,Slot_PIN,KeyName)
        ##print(private_key)
        TypeCSR = "CSR"
        csr_data = Read_File_Func2(TypeCSR,csr_fileName,CompanyName)
        print(csr_data)
